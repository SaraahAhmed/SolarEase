            ...
            Align(
              ...
              child: IconButton(
                 onPressed: () async
                {
                  ...
                  print('jnhsCJHD');
                 await panelService?. AddToFavorite(widget.batteryModel.BatteryID); 
                  print(widget.batteryModel.BatteryID);
                },
                icon: Icon(
                 widget.batteryModel.isFavorite ? Icons.favorite : Icons.favorite_border,
                  color:widget.batteryModel.isFavorite ? Colors.orange : Colors.black,
                ),
              ),
            ),
            Column(
              ...
              return Row(
                children: [
                  Padding(
                    ...
                    child: BatteryCard(batteryModel: snapshot.data![firstIndex]),
                  ),
                   if (hasSecond)
