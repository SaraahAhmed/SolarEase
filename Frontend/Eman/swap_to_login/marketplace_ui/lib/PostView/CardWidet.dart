          ...
          (
            ...
            Align(
                ...
                child: IconButton(
                  ...
                  {
                    setState(() {
                       widget.smallpostmodel.isFavorite= ! widget.smallpostmodel.isFavorite;
                       
                      //isFavorite = !isFavorite;
                      // add to favorite
                    });
                    print('jnhsCJHD');
                   await userPostService ?.AddFvoritePost(widget.smallpostmodel.PostID); 
                    print(widget.smallpostmodel.PostID);
                  },
                  icon: Icon
                  (
                    widget.smallpostmodel.isFavorite ?Icons.favorite : Icons.favorite_border,
                    color: widget.smallpostmodel.isFavorite ? Colors.orange : Colors.black,
