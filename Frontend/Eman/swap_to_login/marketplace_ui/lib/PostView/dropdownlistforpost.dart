      ...
      children: [
        Container(
          ...
          child: DropdownButton<String>(
            ...
            style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold),
            value: _selectedItem,
            items: <String>['all','Panel', 'Inverter', 'Battery','other'].map((String value) {
              return DropdownMenuItem<String>(
                value: value,
                child: Align(
                  alignment: Alignment.center,
        ...
        Container(width: width(250), height: height(3), color: Color(0xffBBBAB6)),
        SizedBox(height: 8),
        SearchWidgwt(),
      ],
    );
